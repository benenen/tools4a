...
/// SOCKS5 client handshake: greeting → optional userpass auth → CONNECT.
/// On return, `outbound` is positioned ready for application bytes.
async fn handshake_and_connect<S>(
    outbound: &mut S,
    user: Option<&str>,
    pass: Option<&str>,
    target_host: &str,
